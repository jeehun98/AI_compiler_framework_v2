...
class CUDAKernelPlan:
    ...
    predicates are required and how the K reduction is traversed.

    Memory movement, multiply-accumulate expressions and emitted executable
    CUDA source are intentionally deferred.
    """
