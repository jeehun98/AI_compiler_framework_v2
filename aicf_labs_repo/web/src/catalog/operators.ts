...
const elementwise = whole(PropertyKind.ELEMENTWISE);

export const OPERATORS: readonly Operator[] = [
  {
    id: 'input', name: 'Input', symbol: 'x', category: 'source', arity: 0, mask: OperatorMask.NONE, propertyClaims: [], inputPorts: [],
  ...
  {
    id: 'constant', name: 'Constant', symbol: 'c', category: 'source', arity: 0, mask: OperatorMask.NONE, propertyClaims: [], inputPorts: [],
  ...
  },
  {
    ...
    applicableRewriteRuleIds: ['add-zero', 'add-commute', 'constant-fold', 'reassociate-associative-right'],
  ...
  },
  {
    ...
    applicableRewriteRuleIds: ['mul-one', 'mul-zero', 'mul-commute', 'constant-fold', 'reassociate-associative-right'],
